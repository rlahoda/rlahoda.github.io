      ...
      case "twitter":
        icon.innerHTML =
          ...
          <path id="original" d="M40.7,115.3c47.6,0,73.7-39.5,73.7-73.7c0-1.1,0-2.2-0.1-3.3c5.1-3.7,9.4-8.2,12.9-13.4
          	c-4.7,2.1-9.7,3.5-14.9,4.1c5.4-3.2,9.4-8.3,11.4-14.3c-5.1,3-10.6,5.1-16.5,6.3c-9.8-10.4-26.2-10.9-36.6-1.1
          	c-6.7,6.3-9.6,15.8-7.5,24.7c-20.8-1-40.2-10.9-53.4-27.1c-6.9,11.8-3.4,27,8,34.6c-4.1-0.1-8.1-1.3-11.7-3.3c0,0.1,0,0.2,0,0.3
          	c0,12.3,8.7,22.9,20.7,25.4c-3.8,1-7.8,1.2-11.7,0.4c3.4,10.6,13.1,17.8,24.2,18C30.2,100.1,18.8,104,7.2,104
          	c-2.1,0-4.1-0.1-6.2-0.4C12.8,111.2,26.6,115.3,40.7,115.3"/>
          </svg>` + icon.innerHTML;
        break;
      case "codepen":
        icon.innerHTML =
          `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        	 viewBox="0 0 128 128" style="enable-background:new 0 0 128 128;" xml:space="preserve">
              ...
              <path  d="M124.3,40.5L67.1,2.1c-1.9-1.3-3.8-1.3-6.3,0L3.7,40.5c-1.9,1.3-2.5,3.1-2.5,5v37.7c0,1.9,0.6,3.8,2.5,4.4
              	l57.1,38.3c1.9,1.3,3.8,1.3,6.3,0l57.1-38.3c1.3-1.3,2.5-2.5,2.5-4.4V45.5C126.8,43.6,126.2,41.7,124.3,40.5L124.3,40.5z M69.7,17.2
              	l42.1,28.3L92.9,58L69.7,42.3C69.7,42.3,69.7,17.2,69.7,17.2z M58.3,17.2v25.1L35.1,58L16.3,45.5L58.3,17.2z M11.9,55.5l13.8,8.8
              	l-13.8,8.8V55.5L11.9,55.5z M58.3,111.4L16.3,83.2l18.8-12.6l23.2,15.7V111.4z M64,76.9L45.2,64.3L64,51.8l18.8,12.6L64,76.9z
              	 M69.7,111.4V86.3l23.2-15.7l18.8,12.6L69.7,111.4z M116.1,73.1l-13.8-8.8l13.8-8.8L116.1,73.1L116.1,73.1z"/>
              </svg>
        ` + icon.innerHTML;
        break;
      case "linkedin":
  ...
  <g>
    ...
    <path d="M112.8,39.3c-1.2-5.5-2.9-9.8-2.9-9.8h0c-0.8,1.3-18.8,10.6-24.2,19.3c-5.4,8.7-6.9,15.6-5,22c1.7,5.6,4.8,6.1,7,7.6
      ...
      case "jest":
       ...
       <path d="M116.62,88.17c-0.95,5.48-4.34,10.27-9.29,13.14c-4.62,2.67-10.15,3.47-16,4.32c-3.14,0.45-6.38,0.92-9.55,1.7
         c-8.38,2.07-16.5,6.1-24.34,10c-15.71,7.8-29.27,14.54-42.06,5.67C6,116.51,6.44,104.49,7.53,97.91c1.01-6.1,3.75-11.72,6.39-17.15
         c0.45-0.92,0.9-1.85,1.34-2.77c1.33,0.53,2.73,0.88,4.16,1.04c-2.69,8.88,1.54,18.55,10.43,23.11l1.22,0.63l1.29-0.46
         c7.03-2.5,13.5-6.52,19.24-11.93c3.71-3.5,6.9-7.38,9.53-11.51c0.8,0.12,1.6,0.18,2.41,0.18c8.16,0,14.91-6.1,15.95-13.97
         c3.34-0.12,6.88-0.12,10.24,0c1.04,7.88,7.8,13.97,15.95,13.97c3.41,0,6.57-1.07,9.18-2.88C116.66,79.86,117.34,84.02,116.62,88.17z
         "/>
       <path  d="M21.21,53.25c5.39,0,9.78,4.39,9.78,9.78c0,1.94-0.57,3.74-1.54,5.26c-1.63,2.54-4.39,4.27-7.56,4.49
         c-0.22,0.01-0.45,0.03-0.67,0.03c-1.2,0-2.35-0.22-3.42-0.62c-2.14-0.81-3.94-2.33-5.08-4.32c-0.84-1.47-1.29-3.14-1.29-4.84
         C11.44,57.64,15.82,53.25,21.21,53.25z"/>
       <path  d="M53.75,62.94c0-4.9,3.62-8.97,8.33-9.67c0.47-0.07,0.96-0.11,1.45-0.11c3.13,0,5.93,1.48,7.72,3.79
         c0.45,0.57,0.83,1.2,1.14,1.85c0.61,1.29,0.92,2.71,0.92,4.14c0,0.78-0.09,1.54-0.27,2.27c-0.95,3.99-4.36,7.04-8.52,7.46
         c-0.32,0.03-0.65,0.05-0.99,0.05c-1.88,0-3.72-0.54-5.3-1.57C55.53,69.41,53.75,66.38,53.75,62.94z"/>
       <path  d="M94.56,51.31c-2.13,2.03-3.66,4.61-4.43,7.45c-3.69-0.14-7.38-0.14-11.06,0c-0.83-3.07-2.54-5.78-4.85-7.83
         l10.12-20.46L94.56,51.31L94.56,51.31z"/>
       <path d="M50.97,0.82h66.71l-15.76,46.47c-0.68,0.16-1.34,0.37-2,0.62L84.36,16.15L68.76,47.71
         c-0.68-0.23-1.38-0.42-2.08-0.56C66.67,47.15,50.97,0.82,50.97,0.82z"/>
       <path  d="M115.45,62.94c0,0.98-0.15,1.93-0.42,2.82c-0.64,2.1-1.97,3.93-3.77,5.19c-1.64,1.15-3.59,1.77-5.59,1.76
         c-4.52,0-8.32-3.08-9.44-7.24c-0.22-0.83-0.34-1.68-0.33-2.54c0-1.34,0.27-2.61,0.76-3.77c0.25-0.59,0.56-1.16,0.92-1.7
         c1.76-2.6,4.73-4.31,8.1-4.31c0.31,0,0.61,0.02,0.92,0.04C111.56,53.67,115.46,57.85,115.45,62.94L115.45,62.94z"/>
       </svg>
        ` + icon.innerHTML;
        break;
      case "pantheon":
...
<path  d="M85.5,53.8c0.4,0,1.1-0.4,1.1-4.2c0-3.8-0.8-4.2-1.1-4.2h-19l3.6,8.5H85.5z"/>
<path  d="M74.4,64h12.7c0.4,0,1.1-0.4,1.1-4.2c0-3.8-0.8-4.2-1.1-4.2H70.8L74.4,64z"/>
<path  d="M85.5,75.8H68.3l3.6,8.5h13.6c0.4,0,1.1-0.4,1.1-4.2C86.6,76.2,85.8,75.8,85.5,75.8"/>
<path  d="M87.2,65.6H64l3.6,8.5h19.5c0.4,0,1.1-0.4,1.1-4.2C88.3,66,87.5,65.6,87.2,65.6"/>
<path  d="M85.5,75.8H68.3l3.6,8.5h13.6c0.4,0,1.1-0.4,1.1-4.2C86.6,76.2,85.8,75.8,85.5,75.8"/>
<path  d="M87.2,65.6H64l3.6,8.5h19.5c0.4,0,1.1-0.4,1.1-4.2C88.3,66,87.5,65.6,87.2,65.6"/>
<path  d="M61.2,63.9l-4.3-10.2h2.1L63.3,64h9.2l-7.9-18.7H44.7c-1.5,0-2.3,0-3.1,2.2c-0.8,2.6-0.9,7.6-0.9,17.3
...
<path d="M93.7,44.4L93.7,44.4c-0.1,0-0.1,0-0.1-0.1c-0.1-0.1-0.1-0.2-0.1-0.3l2.6-15.8l12.1,12.1l-12.6,5.4
